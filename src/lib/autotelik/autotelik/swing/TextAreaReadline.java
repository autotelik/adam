// Copyright:: This is essentially code from the JRuby distribution in org.jruby.demo
// Author ::   Tom Statter
// Date ::     April 2009
// License::
// About::     Copied ages ago (1.3 ??) here ..  but now may be able to simply include
//             from org.jruby.demo.TextAreaReadline ?
//
...
public class TextAreaReadline implements KeyListener {
    ...
    protected void upAction(KeyEvent event) {
        ...
        String oldLine = Readline.getHistory(Readline.getHolder(runtime)).current().toString();
        oldLine.trim();
    ...
    protected String getLine() {
        System.out.println("getLine - startPos : "  + startPos);
        try {
    ...
    protected void enterAction(KeyEvent event) {
        System.out.println("IN TextAreaReadline - enterAction  " + KeyEvent.VK_ENTER);
        event.consume();
        ...
        System.out.println("DO - enterAction");
        append("\n", null);
    ...
    public void append(String toAppend, AttributeSet style) {
       try {
